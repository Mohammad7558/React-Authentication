            ...
            <div className='border rounded-2xl p-10'>
                <div className='flex flex-col lg:flex-row items-center gap-x-5'>
                    ...
                    <div className='w-full lg:w-1/2 lg:mt-0 mt-5'>
                        ...
                        <h1><span className='font-bold'>Date:</span> {date}</h1>
                        <h1><span className='font-bold'>Location:</span> {location}</h1>
                        <h1><span className='font-bold'>Entry Fee:</span> {entry_fee} TK</h1>
                        <button onClick={() => handleRemove(event.id)} className='btn bg-red-500 text-white mt-4'>Remove Booked Event</button>
                    </div>
                </div>
            </div>
        </div>
